...
import com.example.adda.databinding.FragmentChatBinding
...
class ChatFragment : Fragment(), UserAdapter.ItemUserClickListener {
    ...
    private fun getUserInfo() {
        ...
        mDatabase.child("chats").addValueEventListener(object : ValueEventListener {
    ...
    private fun filerChatListedUser() {
        val postListener: ValueEventListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (snapshot in dataSnapshot.children) {
                    ...
                    for (dataSnapshot in chatSnapshot!!.children) {

                        val chatRoom = dataSnapshot.key

                        val reciverRoom = userInfo!!.uid.toString() + sessionManager!!.userIdToken

                        if (chatRoom!! == reciverRoom) {
                ...
                try {
                    ...
                    adapter = UserAdapter(userInfos, requireActivity(), this@ChatFragment, false)
                    binding!!.userRv.adapter = adapter
                } catch (e: Exception) {
                    Log.e("tag", "ChatFragment")
                }
